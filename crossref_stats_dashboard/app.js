...
const experiments = [
  ...
  },
  {
    id: "url-web",
    label: "Deney 23",
    title: "URL & Web / Wayback Resolver",
    found: 7018,
    rate: 70.18,
    description:
      "Deney 22 sonrası kalan 589 web kaynağı, online veri seti, haber ve kurum raporu; gelişmiş URL normalizasyonu, canlı HTTP 200 doğrulama ve Internet Archive Wayback Machine kurtarma motoru üzerinden eşleştirildi.",
    note:
      "589 hedef referanstan 317 tanesi canlı aktif web sayfası (HTTP 200) ve sayfa başlığı doğrulamasıyla kesin (strong) olarak çözümlendi (%53,82 çözüm oranı). Genel başarı %70 barajını aşarak %70,18'e ulaştı.",
    color: "#16a34a",
    components: [
      { label: "Deney 22 baz", value: 6701, color: "#d97706" },
      { label: "Doğrulanan Canlı URL & Web", value: 317, color: "#16a34a" },
    ],
  },
  {
    id: "openalex-s2",
    label: "Deney 24",
    title: "OpenAlex & Semantic Scholar Resolver",
    found: 7046,
    rate: 70.46,
    description:
      "Deney 23 sonrasında kalan referans havuzunda OpenAlex Works API (API Key destekli) ve Semantic Scholar Graph API üzerinden çoklu strateji (Title, Author+Title, Snippet Arama ve Batch ID Lookup) çalıştırıldı.",
    note:
      "28 yeni güçlü (strong) makale, preprint ve rapor eşleşmesi yakalandı. Toplam bulunan 7.046 / 10.000 (%70,46) seviyesine ulaştı.",
    color: "#0284c7",
    components: [
      { label: "Deney 23 baz", value: 7018, color: "#16a34a" },
      { label: "OpenAlex & Semantic Scholar Strong", value: 28, color: "#0284c7" },
    ],
  },
  {
    id: "datacite-reports",
    label: "Deney 25",
    title: "DataCite Report & Dataset Resolver",
    found: 7049,
    rate: 70.49,
    description:
      "Deney 24 sonrası kalan 2.959 referans DataCite REST API üzerinden sorgulanarak özellikle kurum raporları, açık veri setleri, pre-printler ve açık arşiv tezleri resmi DataCite DOI'leriyle eşleştirildi.",
    note:
      "2.959 referansın tamamı tarandı; 3 yeni doğrulanmış DataCite DOI eşleşmesi (Üniversite Raporu, arXiv Preprint ve Çalışma Raporu) elde edildi.",
    color: "#059669",
    components: [
      { label: "Deney 24 baz", value: 7046, color: "#0284c7" },
      { label: "DataCite Strong DOI", value: 3, color: "#059669" },
    ],
  },
  {
    id: "doaj-dergipark",
    label: "Deney 26",
    title: "Structured Citation + DOAJ / DergiPark",
    found: 7053,
    rate: 70.53,
    description:
    ...
    note:
      "4 yeni doğrulanmış açık erişim makalesi (DOAJ ID ve DOI) kazandırıldı. Toplam bulunan 7.053 / 10.000 (%70,53) oldu.",
    color: "#8b5cf6",
    components: [
      { label: "Deney 25 baz", value: 7049, color: "#059669" },
      { label: "DOAJ & Açık Erişim Strong", value: 4, color: "#8b5cf6" },
    ],
  },
  {
    id: "broad",
...
const remainingAfterExperiment19 = {
  ...
  remainingRate: 29.52,
  doiUnlikely: 1335,
  doiUnlikelyRateOfRemaining: 45.22,
};
...
const remainingCategories = [
  ...
  },
  {
    ...
    totalRate: 2.20,
    color: "#dc2626",
    note: "Deney 23 sonrasi kalan web referanslari.",
  },
  {
    key: "thesis",
    label: "Tez",
    ...
    totalRate: 1.49,
    color: "#0891b2",
    note: "Deney 21 YÖK Tez sonrasi kalan tezler.",
  },
  {
  ...
  {
    key: "hidden_doi",
    label: "Gizli / Metin İçi DOI",
    count: 11,
    remainingRate: 0.37,
    totalRate: 0.11,
    color: "#16a34a",
    note: "Metin içinde gömülü DOI formatında desenler.",
  },
];
